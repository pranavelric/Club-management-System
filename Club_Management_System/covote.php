        ...
        foreach ($ar as $a) {
            ...
            <div class="card  " id="cardvote" style="width:300px;margin: 2%;">
                ...
                <div class="card-body  embed-responsive embed-responsive-21by1 "  id="votecard">
                    ...
                    <h4 class="card-title "><b>Roll No :</b><?php echo $a['Roll Number']?></h4>
                    ...
                    foreach ($arr as $aa)
                    {
                        if($aa['clubid']==$a['club']) {
                            ...
                            <form action="votecount.php" method="post">
                                <input type="hidden" name="coco" value="0"/>
                                <input type="hidden" name="co" value="1"/>
                                <input type="hidden" name="senate" value="0"/>
                                <input type="hidden" name="receiverroll" value="<?php echo $a['Roll Number']?>"/>
